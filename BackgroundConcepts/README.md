...
Ontologies represent one type of computable system among many that involve characterizing or describing concepts, categories, terminology, semantics, and perfomring knowledge representation & conceptual (data) modeling. Other similar systems include so-called semantic nets, taxonomies, thesauri, controlled vocabularies, knowledge graphs, etc. The greater potential complexity and functionalities of ontologies differentiate them from other systems. Ontologies have also been called semantic (data) models, conceptual models, and knowledge models. Collectively, these systems are often called 'knowledge organization systems' (KOS) in library and information science contexts, and'semantic artifact' or 'semantic system' elsewhere. In [this publication](https://link.springer.com/epdf/10.1007/s00146-022-01563-3?sharing_token=vTPkTBnljxgVMYEXjVJxCfe4RwlQNchNByi7wbcMAY6oteBq7yORuYWjpo0juGpWhwVh-N8ve91P7ljs5FJ916Dg4pB5D7BC0JX2wZyibKkrmQuMMOFvVfLw0eEJ6zvHkN6fTXs7q7rwfD9_Pp7CBurghTdCinSF2D40YDhEoo4=), I called a subset of these systems 'meaning models' because of their common focus on meaning or semantics. The name for these systems is less important as the development activity, and the features and capabilities of the system being developmed. However, for a categorization 
